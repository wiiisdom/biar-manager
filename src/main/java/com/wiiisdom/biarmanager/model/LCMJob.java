...
public class LCMJob extends InfoObject {
    ...
    public List<File> getFiles() {
        if (this.getFileProperties() == null || this.getFileProperties().getFiles() == null
                || this.getFileProperties().getFiles().getFiles() == null) {
    ...
    public String toString() {
        return this.getClass().getSimpleName() + "{" + " CUID='" + getCUID() + "'" + ", name='" + getName() + "'"
                + ", description='" + getDescription() + "'" + ", fileProperties='" + getFileProperties() + "'" + "}\n";
    }
}