...
import com.wiiisdom.biarmanager.LCMBiarFile;
...
public class LCMBiarFileTest {
    ...
    public void readWebiSampleLcmbiar() throws FileNotFoundException, Exception {
        LCMBiarFile lcmbiar = new LCMBiarFile(
                "src/test/resources/LCM_BIAR_File_With_Refresh_Sample_Webi_Reports.lcmbiar");
        InfoObjects index = lcmbiar.getIndex();
        Assert.assertNotNull(index);
